...
2. Указать разрешения скрипта(permisions), возможные разрешения будут указаны далее.
...
3. image - скрипту позволено обращатся к пространству имён image, которое содержит функции для работы с компонентом image
4. entity - скрипту позволено обращатся к пространству имён entity, которое содержит функции, для создания и удаления сущностей из регистра сущностей